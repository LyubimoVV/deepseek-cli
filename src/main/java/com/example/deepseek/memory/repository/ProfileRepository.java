...
public interface ProfileRepository {
    long create(String name, String description, String systemPrompt, String settings) throws SQLException;
    ...
    void update(long id, String name, String description, String systemPrompt, String settings) throws SQLException;
